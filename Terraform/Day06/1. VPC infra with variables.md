...
resource "aws_vpc" "main" {
  ...
  tags       = merge(local.tags, { Name = "web-vpc" })
}

# Internet Gateway
resource "aws_internet_gateway" "igw" {
  vpc_id = aws_vpc.main.id
  tags   = merge(local.tags, { Name = "web-igw" })
}
...
resource "aws_eip" "nat" {
  domain = "vpc"
  tags   = merge(local.tags, { Name = "web-nat-eip" })
}
...
resource "aws_nat_gateway" "nat" {
  ...
  tags          = merge(local.tags, { Name = "web-nat-gw" })
}
...
resource "aws_route_table" "public" {
  ...
  tags = merge(local.tags, { Name = "web-public-rt" })
}
...
resource "aws_route_table" "private" {
  ...
  tags = merge(local.tags, { Name = "web-private-rt" })
}
...
resource "aws_instance" "public_ec2" {
  ...
  tags = merge(local.tags, { Name = "web-public-ec2" })
}
...
resource "aws_instance" "private_ec2" {
  ...
  tags = merge(local.tags, { Name = "web-private-ec2" })
}
```
