...
This will allow us to open our github repo in a web VS code editor
...
jobs:
  files:
    ...
    steps:
      - name: Create file
        run: echo "THIS IS TEST FILE" > demo.txt
